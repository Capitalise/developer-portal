...
| Marketplace V2 | /api/marketplace/v2 | Launch your app with unlimited live credentials |
...
```bash title="Request"
curl --location --request POST 'https://bravo.dev.capitalise.com/api/marketplace/v2/tenants' \
...
```bash title="Request"
curl --location --request POST 'https://bravo.dev.capitalise.com/api/marketplace/v2/auth/tenants/authorize' \
# highlight-start
...
```bash title="Request"
curl --location --request POST 'https://bravo.dev.capitalise.com/api/marketplace/v2/profile' \
      # highlight-start
